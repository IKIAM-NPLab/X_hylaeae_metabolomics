---
title: "Analysis of the consensus list of metabolites identified in Rtx-5 Semi-standard non-polar colum and SH-Rtx-Wax Polar colum"
...
Loading the consensus list of metabolites identified in polar and non-polar columns.
...
In the following code, we filter for metabolites identified in both columns and add a "Both columns" flag to the Match_flag column.
...
Now we will add a new column to select the major identification level when the metabolite was identified in both columns.
...
In the following code, we will prepare the data for a graphical representation (an UpSet plot) of the identified metabolites in both columns.
...
In the following code, we remove duplicate metabolites to represent the results in an UpSet plot across different identification levels.
...
In the following code, we export the final list of consensus metabolite identification in polar and apolar column.
