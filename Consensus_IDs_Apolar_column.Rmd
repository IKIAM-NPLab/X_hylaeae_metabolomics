---
title: "Procedures to integrate the identified metabolites using deconvoluted data in four algorithms (MZmine, MS-DIAL, eRah, and MSHub) and against libraries' spectra of NIST 20 (**mainlib** and **replib**) using NIS MS Search software - Rtx-5 Semi-standard non-polar colum"
...
all_pie_tb <- data.frame(Category = c("Coeluted",
                                     "Discrepancies",
                                     "Agreement"),
                        Count = c(n_coeluted, n_discrepancies, n_agreement))
